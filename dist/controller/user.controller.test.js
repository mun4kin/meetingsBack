...
var meeting_controller_1 = require("./meeting.controller");
...
describe('Test user controller', function () {
    ...
    it('check  coorect login', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1["default"])(server)
                        .post('/users/login')
                        .send({
                        email: '10@gmail.com',
    ...
    it('check  incorrect password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1["default"])(server)
    ...
    it('check  unknown user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1["default"])(server)
